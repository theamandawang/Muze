...
export default async function Song({
    ...
    if (!session || session.user.expires_in <= 0) {
        //error handle; this shouldn't happen, since our middleware should prevent.
        return;
    }

    //TODO: write api function to clean up this code
    // slug = id of song, used for dynamic routing
    const { slug } = await params;
    // replace when api to retrieve spotify data is implemented
    const track = await (
        await fetch(`https://api.spotify.com/v1/tracks/${slug}`, {
            headers: {
    ...
    return (
        <div className='grid grid-flow-row auto-rows-max mb-[15%] mx-[auto]'>
            <div>
                <div className='relative bg-secondary pt-[14%] z-0'></div>
                <div className='grid grid-cols-12 gap-16 mx-[5%]'>
                    ...
                    <div className='col-span-9 -mt-[19%] z-10'>
                        <div className='bg-primary rounded-3xl text-center place-content-center h-[13%] w-[18%] top-[4%] right-[4%]'>
                            album
                        </div>
                ...
                <div className='grid grid-cols-2'>
                    ...
                    <div className='justify-content-center mx-[30%] my-[7%]'>
                        <div className='grid grid-cols-2 gap-4'>
                            <div className='bg-primary rounded-3xl text-center place-content-center h-16'>
                                ❤️
                            </div>
                            <div className='bg-primary rounded-3xl text-center place-content-center h-16'>
                                👀
                        ...
                        <div className='bg-primary rounded-3xl text-center place-content-center h-16 mt-3'>
                            add review
                        </div>
                    </div>
                </div>
