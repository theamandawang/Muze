...
export default function Profile(){
    return (
        <div>
            <div className="relative bg-secondary h-[10rem]">
            ...
            <div className="grid grid-flow-row auto-rows-max mb-[15%]">
                ...
                <div>
                    <div className="grid grid-cols grid-cols-[1fr_1fr_1fr] px-[5%] gap-x-[8%] mb-[1%]">
                ...
                <hr className="w-[95rem] justify-self-center"/>
