...
export default function Dashboard() {
    return (
        <div className='grid grid-flow-row auto-rows-max mb-[15%] mx-[15%]'>
            <div className='px-[12%]'>
                <span className='sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold'>
                    Hey, Maxine!
                </span>
            </div>
            ...
            <div className='grid grid-cols grid-cols-[2fr_4fr] px-[15%] gap-8 mb-[7%]'>
                ...
                <div>
                    ...
                    <h2 className='sm:text-sm md:text-base lg:text-lg xl:text-xl pt-[1%]'>
                        top-tier vocals and top-tier writing
                    </h2>
                </div>
            </div>
            <div className='grid grid-cols grid-cols-[2fr_4fr] px-[15%] gap-8 mb-[3%]'>
                ...
                />
                <div>
                    <h2 className='sm:text-base md:text-xl lg:text-2xl xl:text-3xl'>
                        i love weezer soooo much ahhh
                    </h2>
                    <h2 className='sm:text-sm md:text-base lg:text-lg xl:text-xl pt-[1%]'>
                        buddy holly somehow manages to top everything i know
                        about love, and i can't wait to hear it live
                    </h2>
                </div>
            </div>
            ...
            <div className='grid grid-cols grid-cols-[1fr_1fr] px-[18%] gap-x-[18%] gap-y-[9%] mt-[7%]'>
                <div>
                    ...
                    <div className='pt-[3%]'>
                        ...
                        <p className='sm:text-sm md:text-base lg:text-lg xl:text-xl pt-[1%]'>
                            if weezer has a million fans, then i am one of them.
                            if weezer has ten fans, then i am one of them. if
                            weezer has only one fan then that is me. if weezer
                            has no fans, then that means i am no longer on this
                            earth. if the world is against weezer, then i am
                            against the world.{' '}
                        </p>
                    </div>
                </div>
                <div>
                    ...
                    <div className='pt-[3%]'>
                        ...
                        <p className='sm:text-sm md:text-base lg:text-lg xl:text-xl pt-[1%]'>
                            alksdjfklsjd soooo good. like literally sooooooo
                            good
                        </p>
                    </div>
                </div>
                <div>
                    ...
                    <div className='pt-[3%]'>
                        <h2 className='sm:text-lg md:text-xl lg:text-2xl xl:text-3xl'>
                            the comfort album we all need sometimes
                        </h2>
                        <p className='sm:text-sm md:text-base lg:text-lg xl:text-xl pt-[1%]'>
                            hits really hard sometimes tbh
                        </p>
                    </div>
                </div>
                <div>
                    ...
                    <div className='pt-[3%]'>
                        ...
                        <p className='sm:text-sm md:text-base lg:text-lg xl:text-xl pt-[1%]'>
                            one of the most reflective, thoughtful pieces albums
                            i’ve listened to in a while. quitely has so much
                            stronger. really enjoyed drunk, running, all falls
                            down, and you forced me to.{' '}
                        </p>
                    </div>
                </div>
            </div>
